...
**Valid prefixes:** `#source/`, `#type/`, `#topic/`, `#domain/`, `#author/`

**Use frontmatter (not tags) for:**
- `status:` — active, waiting, completed, archived
- `priority:` — high, medium, low (or use task syntax)

**Deprecated:** `#priority/`, `#status/`, `#context/` prefixes are no longer used.
